...
- Resolved (Phase 10): Approval/collaboration core uses one-step approval MVP, exact step binding, terminal `FOR UPDATE` locking, transactional outbox/history, deduplicated mentions, soft delete, and canonical deep links.
