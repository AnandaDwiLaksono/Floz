...
ARG TARGETARCH
RUN apt-get update && apt-get install -y --no-install-recommends age=1.1.1-1+b3 postgresql-client-15=15.19-0+deb12u1 ca-certificates=20250419~deb12u1 wget=1.21.3-1+deb12u1 && rm -rf /var/lib/apt/lists/* && groupadd --system floz && useradd --system --gid floz --create-home --home-dir /home/floz floz
